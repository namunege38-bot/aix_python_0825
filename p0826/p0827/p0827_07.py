...
# 정렬 순차정렬(sort), 역순정렬(reverse=Ture)
# arr = [1,5,8,3,2]
# arr.sort()
# print(arr)
...
# # # # print(arr[4]+1)   
# # # # print(arr[2])
# # # # print(len(arr)) # 리스트 개수 lengt의 줄임말
# # # # # 리스트는 [시작]
# # # # # 리스트는 0부터 주소가 시작
# # # # # 리스트를 print하면 모두 출력가능
# # # # # 리스트의 특정주소로 그 값을 출력할 수 있음
# # # # # 리스트 개수 : len()
# # # # # 리스트 안에는 모든 타입을 넣을수 있음 - 정수,실수,문자열,불,리스트,튜폴,딕셔너리
