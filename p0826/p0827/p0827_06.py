score = 65
# score 60점 이상이면 합격, 불합격
if score>+60: print("합격")
else: print("불합격")

# if문 축약
result = "합격" if score>=60 else"불합격" # 명령어가 한줄때만 축약 가능
...
# # 해당 월에 따라 봄,여름,가을,겨울이라고 출력하시오.
# # 겨울 12,2,1 봄 3,4,5 여름 6,7,8 겨울 9,10,11
# # 비교문을 사용해서
# # 해당월 계절을 출력하시오.
# # now.momth
...
# import random
# 랜덤점수를 생성해서
# 90점 이상 A, 80점 이상 B, 7점 이상 C, 그외에는 F
# 랜덤점수 출력하시오.
...
# if score>=60:
#      print("합격입니다")
# elif 59>=score>=50: # score>=50: 도 가능
#      print("재시험입니다")
# else:
#      print("불합격입니다")
# print("랜덤점수 : ",score)
